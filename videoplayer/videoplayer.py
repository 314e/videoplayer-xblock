""" videoplayer-xblock main Python class"""
...
class videoPlayerXBlock(XBlock):
    ...
    def student_view(self, context=None):
        ...
        html = self.render_template(
            'static/html/videoplayer_view.html', context)

        frag = Fragment(html)
        frag.add_css(self.load_resource("static/css/videoplayer.css"))
        frag.add_css(self.load_resource(
            "static/css/shaka-player-controls.min.css"))

        frag.add_javascript(self.load_resource(
            "static/js/shaka-player.compiled.min.js"))
        frag.add_javascript(self.load_resource(
    ...
    def studio_view(self, context=None):
        ...
        html = self.render_template(
            'static/html/videoplayer_edit.html', context)

        frag = Fragment(html)
        frag.add_javascript(self.load_resource(
            "static/js/videoplayer_edit.js"))
        frag.initialize_js('videoPlayerXBlockInitStudio')
        return frag
